...
<!-- Favicons -->
<link rel="apple-touch-icon-precomposed" sizes="144x144" href="../BJC/HTML/assets/ico/apple-touch-icon-144-precomposed.png">
<link rel="apple-touch-icon-precomposed" sizes="114x114" href="../BJC/HTML/assets/ico/apple-touch-icon-114-precomposed.png">
<link rel="apple-touch-icon-precomposed" sizes="72x72" href="../BJC/HTML/assets/ico/apple-touch-icon-72-precomposed.png">
<link rel="apple-touch-icon-precomposed" href="../BJC/HTML/assets/ico/apple-touch-icon-57-precomposed.png">
<link rel="shortcut icon" href="../BJC/HTML/assets/ico/favicon.ico">
<!-- CSS Stylesheet-->
<link type="text/css" rel="stylesheet" href="../BJC/HTML/assets/css/bootstrap/bootstrap.min.css" />
<link type="text/css" rel="stylesheet" href="../BJC/HTML/assets/css/bootstrap/bootstrap-themes.css" />
<link type="text/css" rel="stylesheet" href="../BJC/HTML/assets/css/style.css" />

<!-- Styleswitch if  you don't chang theme , you can delete -->
<link type="text/css" rel="alternate stylesheet" media="screen" title="style1" href="../BJC/HTML/assets/css/styleTheme1.css" />
<link type="text/css" rel="alternate stylesheet" media="screen" title="style2" href="../BJC/HTML/assets/css/styleTheme2.css" />
<link type="text/css" rel="alternate stylesheet" media="screen" title="style3" href="../BJC/HTML/assets/css/styleTheme3.css" />
<link type="text/css" rel="alternate stylesheet" media="screen" title="style4" href="../BJC/HTML/assets/css/styleTheme4.css" />
				...
				<div class="tools-bar">
						...
						<ul class="nav navbar-nav navbar-right tooltip-area">
								...
								<li><a href="#" class="nav-collapse avatar-header">
												<img alt="" src="../BJC/HTML/assets/img/avatar.png"  class="circle">
				...
				<div id="nav-scroll">
						<div class="avatar-slide">
								...
								<div class="avatar-link btn-group btn-group-justified">
										<a class="btn" href="../BJC/HTML/profile.html"  title="Portfolio"><i class="fa fa-briefcase"></i></a>
								...
								<ul>
										<li>
												<section  class="thumbnail-in">
														...
														<div class="im-thumbnail"><img alt="" src="../BJC/HTML/assets/img/avatar2.png" /></div>
														<label></label>
										...
										<li>
												<section class="thumbnail-in">
														...
														<div class="im-thumbnail"><img alt="" src="../BJC/HTML/assets/img/avatar.png" /></div>
						...
						<div class="widget-im notification">
								<ul>
										...
										<li>
												...
												<div class="im-confirm-group">
														<div class=" btn-group btn-group-justified">
																<a class="btn btn-inverse" href="../BJC/HTML/dashboard.html">Go Now.</a>
		...
		<nav id="menu"  data-search="close">
				<ul>
						<li><span><i class="icon  fa fa-laptop"></i> Dashboard</span>
								<ul>
										<li><a href="../BJC/HTML/dashboard.html"><i class="icon  fa fa-rocket"></i> First Design </a></li>
										<li><a href="../BJC/HTML/dashboard2.html"><i class="icon  fa fa-th"></i> Dashboard New </a></li>
								</ul>
						</li>
						<li><a href="../BJC/HTML/front/index.html"><i class="icon  fa fa-rocket"></i> Front End </a></li>
						<li><span><i class="icon  fa fa-th-list"></i> Layout</span>
								<ul>
										<li class="Label label-lg">Main Layout</li>
										<li><a href="../BJC/HTML/alwayMenu.html"> Alway Left  Menu </a></li>
										<li><a href="../BJC/HTML/hideUserPanel.html"> Hide User Panel </a></li>
										<li><a href="../BJC/HTML/hideUserPanelIn.html"> Show & Hide</a></li>
										<li class="Label label-lg">Other Layout</li>
										<li><a href="../BJC/HTML/topMenu.html"> Top Menu</a></li>
										<li><a href="../BJC/HTML/footerShow.html"> Footer Show</a></li>
										<li><a href="../BJC/HTML/footerMenu.html"> Footer with menu</a></li>
								</ul>
						</li>
						<li><a href="../BJC/HTML/mailBox.html"><i class="icon  fa fa-inbox"></i> Mail</a></li>
						<li><span><i class="icon  fa fa-briefcase"></i> UI Element</span>
								<ul>
										<li><a href="../BJC/HTML/ui.html"> UI </a></li>
										<li><a href="../BJC/HTML/ui_button.html"> Button </a></li>
										<li><a href="../BJC/HTML/ui_icon.html"> Fonts Icon</a></li>
										<li><a href="../BJC/HTML/ui_slide.html"> Slide</a></li>
										<li><a href="../BJC/HTML/ui_modal.html"> Modal</a></li>
										<li><a href="../BJC/HTML/ui_panel.html"> Panel</a></li>
										<li><a href="../BJC/HTML/ui_alert.html"> Alert</a></li>
										<li><a href="../BJC/HTML/ui_typography.html"> Typography</a></li>
										<li><a href="../BJC/HTML/ui_nestable.html"> Nestable</a></li>
								</ul>
						</li>
						<li><span><i class="icon  fa fa-bar-chart-o"></i> Chart </span>
								<ul>
										<li><a href="../BJC/HTML/chartFlot.html"> Flot Chart</a></li>
										<li><a href="../BJC/HTML/chartMorris.html"> Morris Chart</a></li>
										<li><a href="../BJC/HTML/chartOther.html"> Other Chart</a></li>
								</ul>
						</li>
						<li><a href="../BJC/HTML/calendar.html"><i class="icon  fa fa-calendar-o"></i> Calendar </a></li>
						<li><span><i class="icon  fa fa-align-right"></i>Off  Canvas  Menu</span>
								<ul>
										<li><a href="../BJC/HTML/menu.html"> Position </a></li>
										<li><a href="../BJC/HTML/menuOpen.html"> Touch to open</a></li>
										<li><a href="../BJC/HTML/menuVertical.html"> Vertical Level</a></li>
						...
						<li><span><i class="icon  fa fa-clipboard"></i> From</span>
								<ul>
										<li><a href="../BJC/HTML/form.html">Form Basic</a></li>
										<li><a href="../BJC/HTML/formComponents.html">Form Components</a></li>
										<li><a href="../BJC/HTML/formValidate.html">Form Validate</a></li>
										<li><a href="../BJC/HTML/formWizard.html">Form Wizard</a></li>
										<li><a href="../BJC/HTML/formMutiselect.html">Form Mutiseletion</a></li>
										<li><a href="../BJC/HTML/form_x_edit.html">Form x-edit</a></li>
										<li><a href="../BJC/HTML/drop_upload.html">Drop Upload</a></li>
								</ul>
						</li>
						<li><a href="../BJC/HTML/fileManager.html"><i class="icon  fa fa-file-text"></i> File Manager </a></li>
						<li><span><i class="icon  fa fa-fire"></i> Table</span>
								<ul>
										<li><a href="../BJC/HTML/table.html">Table Basic</a></li>
										<li><a href="../BJC/HTML/tableResponsive.html">Table Responsive</a></li>
										<li><a href="../BJC/HTML/tableDynamic.html">Data Table</a></li>
								</ul>
						</li>
						<li><span><i class="icon  fa fa-folder-open-o"></i> Other Page</span>
								<ul>
										<li><a href="../BJC/HTML/login.html"> login </a></li>
										<li><a href="../BJC/HTML/lockscreen.html"> Lockscreen </a></li>
										<li><a href="../BJC/HTML/images_manager.html"> Images Manager</a></li>
										<li><a href="../BJC/HTML/gallery.html"> Gallery</a></li>
										<li><a href="../BJC/HTML/timeline.html"> Timeline</a></li>
										<li><a href="../BJC/HTML/profile.html"> Profile</a></li>
										<li><a href="../BJC/HTML/blankPage.html"> Blank Page</a></li>
										<li><a href="../BJC/HTML/page_invoice.html"> Invoice</a></li>
										<li><a href="../BJC/HTML/page_search.html"> Search result</a></li>
										<li><a href="../BJC/HTML/pages_pricing.html"> Pricing Table</a></li>
										<li><a href="../BJC/HTML/register.html"> Register</a></li>
										<li><a href="../BJC/HTML/page_chat.html"> Full Chat</a></li>
								</ul>
						</li>
						<li><a href="../BJC/HTML/map.html"><i class="icon  fa fa-map-marker"></i> Maps</a></li>
						<li><a href="../BJC/HTML/404.html"><i class="icon  fa fa-exclamation-triangle"></i> Error Pages</a></li>
						<li><a href="../BJC/HTML/siteMap.html"><i class="icon  fa fa-sitemap"></i>Site Map</a></li>
				</ul>
		</nav>
		<!-- //nav left menu-->
				...
				<ul>
						...
						<li data-counter-color="theme">
								...
								<ul>
										...
										<li class="img">
												<a href="#" class="online">
														<img alt="" src="../BJC/HTML/assets/photos_preview/50/people/1.jpg" /> Alexa 
														<small>Johnson</small>
												</a>
										</li>
										<li class="img">
												<a href="#" class="busy">
														<img alt="" src="../BJC/HTML/assets/photos_preview/50/people/2.jpg" /> Alexander 
														<small>Brown</small>
												</a>
										</li>
										<li class="Label">F</li>
										<li class="img">
												<a href="#">
														<img alt="" src="../BJC/HTML/assets/photos_preview/50/people/3.jpg" /> Fred
														<small>Smith</small>
												</a>
										</li>
										<li class="Label">J</li>
										<li class="img">
												<a href="#">
														<img alt="" src="../BJC/HTML/assets/photos_preview/50/people/4.jpg" /> James
														<small>Miller</small>
												</a>
										</li>
										<li class="img">
												<a href="#">
														<img alt="" src="../BJC/HTML/assets/photos_preview/50/people/5.jpg" /> Jefferson
														<small>Jackson</small>
												</a>
										</li>
										<li class="img">
												<a href="#">
														<img alt="" src="../BJC/HTML/assets/photos_preview/50/people/6.jpg" /> Jordan
														<small>Lee</small>
												</a>
										</li>
										<li class="Label">K</li>
										<li class="img">
												<a href="#" class="online">
														<img alt="" src="../BJC/HTML/assets/photos_preview/50/people/7.jpg" /> Kim
														<small>Adams</small>
												</a>
										</li>
										<li class="Label">M</li>
										<li class="img">
												<a href="#">
														<img alt="" src="../BJC/HTML/assets/photos_preview/50/people/8.jpg" /> Meagan
														<small>Miller</small>
												</a>
										</li>
										<li class="img">
												<a href="#" class="busy">
														<img alt="" src="../BJC/HTML/assets/photos_preview/50/people/9.jpg" /> Melissa
														<small>Johnson</small>
												</a>
										</li>
										<li class="Label">N</li>
										<li class="img">
												<a href="#" class="online">
														<img alt="" src="../BJC/HTML/assets/photos_preview/50/people/10.jpg" /> Nicole
														<small>Smith</small>
												</a>
										</li>
										<li class="Label">S</li>
										<li class="img">
												<a href="#" class="online">
														<img alt="" src="../BJC/HTML/assets/photos_preview/50/people/1.jpg" /> Samantha
														<small>Harris</small>
												</a>
										</li>
										<li class="img">
												<a href="#" class="block">
														<img alt="" src="../BJC/HTML/assets/photos_preview/50/people/2.jpg" /> Scott
						...
						<li>
								...
								<ul>
										...
										<li class="img">
												<a href="#" class="busy">
														<img alt="" src="../BJC/HTML/assets/photos_preview/50/people/3.jpg" /> Adam
														<small>White</small>
												</a>
										</li>
										<li class="Label">B</li>
										<li class="img">
												<a href="#" class="busy">
														<img alt="" src="../BJC/HTML/assets/photos_preview/50/people/4.jpg" /> Ben
														<small>Robinson</small>
												</a>
										</li>
										<li class="img">
												<a href="#">
														<img alt="" src="../BJC/HTML/assets/photos_preview/50/people/5.jpg" /> Bruce
														<small>Lee</small>
												</a>
										</li>
										<li class="Label">E</li>
										<li class="img">
												<a href="#">
														<img alt="" src="../BJC/HTML/assets/photos_preview/50/people/6.jpg" /> Eddie
										...
										<li class="img">
												<a href="#" class="online">
														<img alt="" src="../BJC/HTML/assets/photos_preview/50/people/7.jpg" /> Jack
														<small>Johnson</small>
												</a>
										</li>
										<li class="img">
												<a href="#">
														<img alt="" src="../BJC/HTML/assets/photos_preview/50/people/8.jpg" /> John
														<small>Jackman</small>
												</a>
										</li>
										<li class="Label">M</li>
										<li class="img">
												<a href="#">
														<img alt="" src="../BJC/HTML/assets/photos_preview/50/people/9.jpg" /> Martina
														<small>Thompson</small>
												</a>
										</li>
										<li class="img">
												<a href="#" class="busy">
														<img alt="" src="../BJC/HTML/assets/photos_preview/50/people/10.jpg" /> Matthew
														<small>Watson</small>
												</a>
										</li>
										<li class="Label">O</li>
										<li class="img">
												<a href="#" class="online">
														<img alt="" src="../BJC/HTML/assets/photos_preview/50/people/1.jpg" /> Olivia
														<small>Taylor</small>
												</a>
										</li>
										<li class="img">
												<a href="#" class="online">
														<img alt="" src="../BJC/HTML/assets/photos_preview/50/people/2.jpg" /> Owen
														<small>Wilson</small>
												</a>
										</li>
								</ul>
						...
						<li data-counter-color="theme-inverse">
								...
								<ul>
										...
										<li class="img">
												<a href="#">
														<img alt="" src="../BJC/HTML/assets/photos_preview/50/people/3.jpg" /> David
														<small>Harris</small>
												</a>
										</li>
										<li class="img">
												<a href="#">
														<img alt="" src="../BJC/HTML/assets/photos_preview/50/people/4.jpg" /> Dennis
														<small>King</small>
												</a>
										</li>
										<li class="Label">E</li>
										<li class="img">
												<a href="#" class="online">
														<img alt="" src="../BJC/HTML/assets/photos_preview/50/people/5.jpg" /> Eliza
														<small>Walker</small>
												</a>
										</li>
										<li class="Label">L</li>
										<li class="img">
												<a href="#" class="busy">
														<img alt="" src="../BJC/HTML/assets/photos_preview/50/people/6.jpg" /> Larry
														<small>Turner</small>
												</a>
										</li>
										<li class="img">
												<a href="#" class="online">
														<img alt="" src="../BJC/HTML/assets/photos_preview/50/people/7.jpg" /> Lisa<br />
														<small>Wilson</small>
												</a>
										</li>
										<li class="Label">M</li>
										<li class="img">
												<a href="#">
														<img alt="" src="../BJC/HTML/assets/photos_preview/50/people/8.jpg" /> Michael
														<small>Jordan</small>
												</a>
										</li>
										<li class="Label">R</li>
										<li class="img">
												<a href="#">
														<img alt="" src="../BJC/HTML/assets/photos_preview/50/people/9.jpg" /> Rachelle
														<small>Cooper</small>
												</a>
										</li>
										<li class="img">
												<a href="#" class="online">
														<img alt="" src="../BJC/HTML/assets/photos_preview/50/people/10.jpg" /> Rick
														<small>James</small>
												</a>
										</li>
								</ul>
						...
						<li class="img">
								<a href="#" class="online">
										<img alt="" src="../BJC/HTML/assets/photos_preview/50/people/5.jpg" /> Samantha
										<small>Harris</small>
								</a>
						</li>
...
<!-- Jquery Library -->
<script type="text/javascript" src="../BJC/HTML/assets/js/jquery.min.js"></script>
<script type="text/javascript" src="../BJC/HTML/assets/js/jquery.ui.min.js"></script>
<script type="text/javascript" src="../BJC/HTML/assets/plugins/bootstrap/bootstrap.min.js"></script>
<!-- Modernizr Library For HTML5 And CSS3 -->
<script type="text/javascript" src="../BJC/HTML/assets/js/modernizr/modernizr.js"></script>
<script type="text/javascript" src="../BJC/HTML/assets/plugins/mmenu/jquery.mmenu.js"></script>
<script type="text/javascript" src="../BJC/HTML/assets/js/styleswitch.js"></script>
<!-- Library 10+ Form plugins-->
<script type="text/javascript" src="../BJC/HTML/assets/plugins/form/form.js"></script>
<!-- Datetime plugins -->
<script type="text/javascript" src="../BJC/HTML/assets/plugins/datetime/datetime.js"></script>
<!-- Library Chart-->
<script type="text/javascript" src="../BJC/HTML/assets/plugins/chart/chart.js"></script>
<!-- Library  5+ plugins for bootstrap -->
<script type="text/javascript" src="../BJC/HTML/assets/plugins/pluginsForBS/pluginsForBS.js"></script>
<!-- Library 10+ miscellaneous plugins -->
<script type="text/javascript" src="../BJC/HTML/assets/plugins/miscellaneous/miscellaneous.js"></script>
<!-- Library Themes Customize-->
<script type="text/javascript" src="../BJC/HTML/assets/js/caplet.custom.js"></script>
</body>
</html>